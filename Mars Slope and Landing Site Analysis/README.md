...
| Dataset | Source |
|---|---|
| MOLA DEM (Mars Orbiter Laser Altimeter) | NASA / USGS |
| Historical Landing Site Coordinates | NASA / manually digitized |
...
3. **Reclassification** — Slope values reclassified into suitability categories; lower slope = higher suitability
4. **Landing Site Digitization** — Historical sites digitized as point features, labeled by mission name
5. **Coordinate System** — All layers projected to **Mars 2000 (Sphere)**
6. **Layout Design** — Final map composed in ArcGIS Pro layout view for poster-style presentation
...
| Opportunity (MER-B) | NASA | 2004 |
| Spirit (MER-A) | NASA | 2004 |
| Curiosity (MSL) | NASA | 2012 |
| InSight | NASA | 2018 |
| Perseverance (Mars 2020) | NASA | 2021 |
...
- **Mars 2000 (Sphere)** — Coordinate reference system
...
B.S. Information Technology & Informatics | B.S. Geography (GIS/Tech Track)  
